...
const lightThemes = {
  gold: {
    ...
    photoShadow:  '0 4px 20px rgba(0,0,0,0.10), 0 0 12px rgba(251,191,36,0.20)',
    nameColor:    'text-slate-800',
    roleColor:    'text-amber-600',
    dividerLine:  'bg-amber-400/70',
    backTextColor:'text-slate-600',
  ...
  blue: {
    ...
    accentBar:    'bg-sky-500',
    photoBorder:  'border-sky-400/40',
    photoShadow:  '0 4px 20px rgba(0,0,0,0.10), 0 0 12px rgba(56,189,248,0.20)',
    nameColor:    'text-slate-800',
    roleColor:    'text-sky-600',
    dividerLine:  'bg-sky-400/70',
    backTextColor:'text-slate-600',
    quoteColor:   'text-sky-400/50',
  },
  red: {
    ...
    accentBar:    'bg-rose-500',
    photoBorder:  'border-rose-400/40',
    photoShadow:  '0 4px 20px rgba(0,0,0,0.10), 0 0 12px rgba(251,113,133,0.20)',
    nameColor:    'text-slate-800',
    roleColor:    'text-rose-600',
    dividerLine:  'bg-rose-400/70',
    backTextColor:'text-slate-600',
    quoteColor:   'text-rose-400/50',
  },
  green: {
    ...
    accentBar:    'bg-emerald-500',
    photoBorder:  'border-emerald-400/40',
    photoShadow:  '0 4px 20px rgba(0,0,0,0.10), 0 0 12px rgba(52,211,153,0.20)',
    nameColor:    'text-slate-800',
    roleColor:    'text-emerald-600',
    dividerLine:  'bg-emerald-400/70',
    backTextColor:'text-slate-600',
    quoteColor:   'text-emerald-400/50',
  },
};

export { boardMembersData, coordinatorsData, supervisorsData, themes, lightThemes };