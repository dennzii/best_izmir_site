...
function Contact() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        alert("Mesajınız alındı! (Bu bir demosu)");
    };
            ...
            <div className="relative z-10 container mx-auto px-4 py-24 md:py-32 flex flex-col items-center">
                ...
                >
                    ...
                    <p className="text-indigo-300 text-lg md:text-xl font-medium tracking-wide max-w-2xl mx-auto">
                        Sorularınız, projeleriniz veya sadece bir merhaba demek için buradayız.
                    </p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 w-full max-w-6xl">
                    ...
                    >
                        ...
                        <div className="bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
                            ...
                            <div className="space-y-6">
                                <ContactItem
                                    icon={<FaMapMarkerAlt />}
                                    title="Adres"
                                    content="Ege Üniversitesi Kampüsü, Mühendislik Fakültesi, Bilgisayar Müh. Bölümü, Bornova/İzmir"
                                />
                                <ContactItem
                                    icon={<FaEnvelope />}
                                    title="E-posta"
                                    content="iletisim@bestizmir.org"
                                />
                            </div>
                        </div>
                        ...
                        {/* Social Media Card */}
                        <div className="bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
                            <h3 className="text-2xl font-bold text-white mb-6">Bizi Takip Edin</h3>
                            <div className="flex gap-4">
                                <SocialButton icon={<FaInstagram />} href="#" />
                                <SocialButton icon={<FaLinkedin />} href="#" />
                                <SocialButton icon={<FaYoutube />} href="#" />
                            </div>
                        </div>
                    ...
                    >
                        <form onSubmit={handleSubmit} className="bg-white/5 backdrop-blur-md border border-white/10 p-8 md:p-10 rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
                            <h3 className="text-2xl font-bold text-white mb-8">Mesaj Gönderin</h3>

                            <div className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <InputGroup label="Adınız Soyadınız" type="text" placeholder="John Doe" />
                                    <InputGroup label="E-posta Adresiniz" type="email" placeholder="john@example.com" />
                                </div>
                                <InputGroup label="Konu" type="text" placeholder="Proje işbirliği hakkında..." />

                                <div className="flex flex-col space-y-2">
                                    <label className="text-sm font-bold text-indigo-300 ml-1">Mesajınız</label>
                                    <textarea
                                        rows="5"
